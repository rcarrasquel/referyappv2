...
const adminItems = computed(() => [
    ...
    { name: copy.value.queueMonitor, href: '/queue-monitor', icon: ClockIcon },
...
const businessItems = computed(() => [
    ...
    { name: copy.value.clients, href: '/clients', icon: UserGroupIcon },
    { name: copy.value.loyalty, href: '/loyalty-programs', icon: TrophyIcon },
